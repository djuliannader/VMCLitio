...
function psid(rho1,phi1,z1,rho2,phi2,z2,rho3,phi3,z3,iflag)
      ...
      pfac = z3*(1+a*r12)
      if (iflag==1)
        wfm=1*((al12*(1+c12*r12*(2 + d12*r12)))/(1 + d12*r12)^2)*pfac*expfac+ a*z3*expfac
      end
      if (iflag==2)
        wfm=(al13)*pfac*expfac
      end
      if (iflag==3)
        wfm=(al23)*pfac*expfac
      end
      return wfm
      end
...
function numerator(rho2,phi2,z2,rho3,phi3,z3)
	 ...
	 psi213d=psid(rho2,phi2,z2,rho1,phi1,z1,rho3,phi3,z3,1)
	 psi321d=psid(rho3,phi3,z3,rho2,phi2,z2,rho1,phi1,z1,3)
	 psi132d=psid(rho1,phi1,z1,rho3,phi3,z3,rho2,phi2,z2,2)
	 psi312d=psid(rho3,phi3,z3,rho1,phi1,z1,rho2,phi2,z2,3)
	 psi231d=psid(rho2,phi2,z2,rho3,phi3,z3,rho1,phi1,z1,2)
	 #
	 P1 = (1/(2*3^(1/2)))*(2*psi123+2*psi213-psi321-psi132-psi231-psi312)
	 P2 = (1/2)*(psi321-psi132-psi231+psi312)
	 P3 = (1/2)*(psi321-psi132+psi231-psi312)
...
println("Expectation values for Lithium-like atoms 1s^22p state")
